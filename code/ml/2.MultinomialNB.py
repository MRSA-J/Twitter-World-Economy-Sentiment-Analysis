...
BEST_MODEL_PATH = "./model/2.best_model.pkl"
VECTORIZER_PATH = "./model/2.vectorizer.pkl"
...
def predict(words, best_model):
    ### words are string type
    ...
    print('Sentence to be predicted:', words)
    print("Predicted sentiment:", label_map[sentiment_prediction[0]])
...
get_best_model()
# sample prediction
SAMPLE_NEURAL = "does I win?"
predict(SAMPLE_NEURAL, BEST_MODEL_PATH)

SAMPLE_POSITIVE = "That doesn't concern me. "
predict(SAMPLE_POSITIVE, BEST_MODEL_PATH)

SAMPLE_NEGATIVE = "ONLY Western World economy WILL suffer."
predict(SAMPLE_NEGATIVE, BEST_MODEL_PATH)
